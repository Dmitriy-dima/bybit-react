					...
					<div className="grid-pattern">
						...
						<div className="start-content">
							...
							<h1 className="title">
								...
								<span className="title-bottom">is now available for Windows</span>
							</h1>

							<p className="subtitle">
								Discover a new way of trading with Bybit desktop application. Join us on your PC and
								claim the exclusive reward
							</p>
							<button
								disabled={!isWindows}
							...
							>
								<span>{isWindows ? "Download for PC" : "Available on Windows"}</span>
							</button>
							<div className="epsilon-highlights">
								...
								<img className="primaryLight" src={primaryLight} alt="primaryLight" />
								<img className="secondaryLight-first" src={secondaryLight} alt="secondaryLight" />
								<img className="secondaryLight-second" src={secondaryLight} alt="secondaryLight" />
							</div>
						</div>
					</div>
				</div>
